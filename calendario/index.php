...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
        ...
        //Necesitas poner un periodo donde pones el inicio del semestre y el final de este con el año
		//$periodo= $inicio_normal."  ".$final_normal;
        ...
        $query="INSERT INTO calendario VALUES(null,'$titulo','$body','','$clase','$inicio','$final','$inicio_normal','$final_normal','$periodo')";
        // Ejecutamos nuestra sentencia sql
        $conexion->query($query)or die('<script type="text/javascript">alert("Horario No Disponible ")</script>');
        header("Location:$base_url");        
        // Obtenemos el ultimo id insetado
        $im=$conexion->query("SELECT MAX(id) AS id FROM calendario");
        $row = $im->fetch_row();  
        $id = trim($row[0]);
        // para generar el link del evento
        $link = "$base_url"."descripcion_evento.php?id=$id";
        // y actualizamos su link
        $query="UPDATE calendario SET url = '$link' WHERE id = $id";
        // Ejecutamos nuestra sentencia sql
...
<Navigation>
    <div class="container">
    <header>
<img src="css/calendar.jpg" width="70" height="70"><h1>Calendario Docente </h1>
</header>
        <div class="row">
...
<!--Actualizar periodo en este boton crea una consulta para sacar el periodo 
<input type="text" class="form-control" placeholder="Periodo"></input>-->
<div class="input-group-append">
<!--<button class="btn btn-primary">Actualizar periodo</button>
Termina periodo-->
</div></div></div></div></div>
<br><br><br>
        <div class="row">
                ...
                <form action="" method="post">
                   ...
                   <label for="tipo">Tipo de evento</label>
                    <select class="form-control" name="class" id="tipo">
                        <!--Color Verde-->
                        <option value="inicio-del-curso">Inicio del curso</option>
                        <!--Color Rojo-->
                        <option value="primer-reporte">Primer reporte</option>
                        <!--Color Rojo-->
                        <option value="segundo-reporte">Segndo reporte</option>
                        <!--Color Rojo-->
                        <option value="tercer-reporte">Tercer reporte</option>
                        <!--Color Amarillo-->
                        <option value="ultimo-dia-de-clases">Ultimo dia de clases</option>
                        <!--Color Azul-->
                        <option value="segunda-oportunidad">Segunda oportunidad</option>
                        <!--Color Morado-->
                        <option value="dias-inhabiles">Dias inhabiles</option>
                        <!--Color Rojo-->
