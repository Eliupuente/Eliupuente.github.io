...
-- Tiempo de generación: 11-06-2020 a las 18:09:33
...
CREATE TABLE `Calendario` (
  ...
  `inicio_normal` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `final_normal` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'garza_go', '1u2s3u4a5r6i7o', 'Docente', 'Jesus', 'Garza', 'Ortega', 'Centro de Computo', '\"../../IMG/Firma.jpg\"', '\"../../IMG/Avatar.jpg\"');
...
ALTER TABLE `Calendario`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_CampoUnico` (`id`),
  ADD KEY `id` (`id`),
