...
style=" margin:1px; border: black 2px solid; font-size: 150%;">
  <a class="navbar-brand">
    <img src="css/icon.png" width="30" height="30" class="d-inline-block align-top" alt="">
    Intrumentación del curso.
  </a>
</nav>
<!--cuadro de la lista-->
<nav class="navbar navbar-light bg-light" style=" margin:1px; border: black 2px solid; font-size: 150%;">
  <a class="navbar-brand">
    <img src="css/lista.png" width="30" height="30" class="d-inline-block align-top" alt="">
    Lista de instrumentaciones. 
