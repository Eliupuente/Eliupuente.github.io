...
<div class="btn-group open" style=" margin-left: 24rem">
  ...
  <ul class="dropdown-menu">
    <li><a href="../tablero/index.php"><i class="fas fa-user"></i> Perfil</a></li>
    <li><a href="#"><i class="fas fa-bell"></i> Notificaciones</a></li>
    <li class="divider"></li>
    <li><a href="../Login/desconect.php"><i class="fas fa-sign-out-alt"></i></i> Cerrar secion</a></li>
  </ul>
  </div>
...
<iframe src="../tablero/index.php" style="width: 100%; height: 90.1%" name="formularios"></iframe>       
